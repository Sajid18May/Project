...
public class DecryptLSB {
	...
	/*
	 * Gets two dimensional array of colors from the image to decrypt.
	 */
	...
	/*adding the values to pixel array
	 * 
	 */
	...
	/* Turns the integer values of pixel array to binary
	 * 
	 */
	...
	/* 
	 * Removes the padded zeros ,converts ASCII to text and returns the message
	 */
